        ...
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-300">
            <div className="bg-white p-8 rounded-2x1 shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {error && (
                        <p className="text-red-500 text-sm tex-center">{error}</p>
                    )}
                    <button className="w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition-all duration-200 font-semibold">
                        Se connecter
                    </button>
                </form>
                <p className="text-center text-gray-500 text-sm mt-4">
                    Utilisez : <span className="font-medium">admin@gmail.com / admin123</span>
                </p>
            </div>
        </div>
    )
