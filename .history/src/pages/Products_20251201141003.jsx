        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md max-h-[90vh] flex flex-col p-6 relative">
            <div className="bg-cyan-800 text-white py-3 px-4 rounded-t-2xl -mx-6 -mt-6 mb-4 text-lg font-semibold">
              ...
              <select value={modalData.coop} onChange={(e) =>setModalData({...modalData({...modalData, coom: e.target.value})})} className="p-2 border rounded">
                <option>Choisir coopérative</option>
                {cooperatives.map((c) => (
                  <option key={c}>{c}</option>
                ))}
              </select>
              <select value={modalData.category} onChange={(e) => setModalData({...modalData, gateg: e.target.value})} className="p-2 border rounded"></select>
              <div>
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center">
          <div className="bg-white p-6 w-96 rounded-xl shadow-xl">
            <div className="flex flex-col gap-3">
              <select value={formData.category} onChange={(e) => setFormData({ ...formData, categ: e.target.value })} className="p-2 border rounded">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, quant: e.target.value })
                }
