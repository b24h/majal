        ...
        <div className="fixed inset-0 bg-black/50 bg-opacity-600 flex justify-center items-center p-4 z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-lg">
            ...
            <div className="flex justify-end space-x-2 mt-2">
              <button onClick={() => setFormOpen(false)} className="px-4 py-2 rounded-full border text-gray-700">
                Annuler
              </button>

              <button onClick={handleCreateCoupon} className="bg-cyan-800 text-white px-5 py-2 rounded-full hover:bg-cyan-700">{editingIndex !== null ? "Enregistrer" : "Créer"}
              </button>
            </div>
          </div>
        </div>
