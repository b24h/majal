                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-white px-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-cyan-600 mb-2" 
                            required />
                    </div>
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-white px-4 py-2 border rounded-full focus:outline-none focus:ring-cyan-700 mb-4" 
                            required />
                    </div>
                    {error && (
