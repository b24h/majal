...
export default function Cooperatives() {
  ...
  // TODO PLUS TARD: récupérer automatiquement les produits liés à chaque coopérative
  const calculateProductCount = (coopId) => {
    return 0; // temporaire, sera connecté à ta vraie liste de produits
  };
        ...
        prev.map((c) =>
          c.id === editingCoop.id
            ? {
                ...editingCoop,
                ...coopData,
                productCount: editingCoop.productCount,
              }
            : c
        )
      );
