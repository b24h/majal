...
export default function Discounts() {
  ...
  return (
    <div className="p-8 relative min-h-screen">
      <div className="mb-6 flex flex-col gap-4">
        <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <AddButton onClick={openAddForm}>Créer un pack</AddButton>
                </div>
              </div>
        <div className="flex items-center justify-between">
          ...
          <div className="w-1/2">
            <input
              ...
              className="w-full bg-cyan-800 text-gray-200 rounded-full px-4 py-2 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-200"
            />
          </div>
        </div>

        <div className="flex items-center gap-3">
          {["Tous", "Active", "Planifiée", "Expirée"].map((tab) => (
            <button
              key={tab}
      ...
      <button
        onClick={openAdd}
        className="fixed bottom-8 right-6 bg-cyan-600 text-white pb-2 w-13 h-13 flex items-center justify-center rounded-full text-3xl shadow-lg hover:bg-cyan-700 transition"
      >
        +
      </button>
