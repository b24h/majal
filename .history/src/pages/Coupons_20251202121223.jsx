          ...
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md max-h-[90vh] flex flex-col p-6 relative">
            ...
            <div className="px-6 pb-6 overflow-y-auto">
              ...
              <div>
                ...
                <input type="text" className="mt-1 w-full border rounded-lg p-2" value={newCoupon.code}
                  onChange={(e) => setNewCoupon({ ...newCoupon, code: e.target.value })}/>
             

            
                <input type="number" className="mt-1 w-full border rounded-lg p-2"
                  value={newCoupon.percentage} onChange={(e) => setNewCoupon({ ...newCoupon, percentage: e.target.value })}/>
            

          
                <input type="date" className="mt-1 w-full border rounded-lg p-2" value={newCoupon.startDate}
                  onChange={(e) => setNewCoupon({ ...newCoupon, startDate: e.target.value })}/>
        

             
                  <input type="date" className="mt-1 w-full border rounded-lg p-2" value={newCoupon.endDate}
