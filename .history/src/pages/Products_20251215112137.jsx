...
export default function Products() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesCoop = selectedCooperative === "Tous" || product.cooperativeId === selectedCooperatives;
      const matchesCat = selectedCategory === "Tous" || product.categoryId === selectedCategory;
    ...
    <div className="relative p-6 font-poppins">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center justify-center border border-dashed border-cyan-900 rounded-2xl py-16 mt-10">
          <h2 className="text-xl font-medium text-gray-800">Aucun produit trouvé</h2>
          <p className="text-gray-500 mb-6">Ajoutez vos produits pour commencer</p>
          <button
            className="bg-cyan-800 text-white px-5 py-2 rounded-full hover:bg-cyan-700"></button>
        </div>
      )}
