...
export default function Sidebar(){
    ...
    return(
        <div className={`${ collapsed ? "w-20" : "w-64"} bg-bleufonce-700 text-white h-screen flex flex-col transition-all duration-300`}>
...
function SidebarLink({to, icon, label, collapsed}){
    return(
        <Link to={to} className="flex items-center gap-3 py-2 rounded-lg hover:bg-indigo-600 transition">
            {icon}
