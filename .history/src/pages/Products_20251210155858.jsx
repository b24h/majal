...
export default function Products() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesCoop = selectedCooperative === "Tous" || product.cooperativeId === selected Cooperatives;
      const matchesCat = selectedCategory === "Tous" || product.categoryId === selectedCategory;
        return matchesSearch && matches Status && 
        product.name.toLowerCase().includes(search.toLowerCase()) &&
        (selectedCooperative ? product.cooperativeId === selectedCooperative : true) &&
