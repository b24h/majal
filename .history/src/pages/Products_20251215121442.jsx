...
export default function Products() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.error("Erreur lors de l'enregistrement :", err.response?.data || data);
    }
  };
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesCoop =
        ...
        product.cooperativeId === selectedCooperatives;
      const matchesCat =
            ...
            >
              ...
              <div className="mt-4 flex-1">
                ...
                <p className="text-sm text-orange-600 mt-1 line-clamp-2">
                  {cooperatives.find((c) => c.id === p.cooperativeId)?.name ||
                    "Inconnu"}
                </p>
