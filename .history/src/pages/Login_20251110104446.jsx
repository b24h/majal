            ...
            <div className="bg-white p-8 rounded-2x1 shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@gmail.com" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring" />
                    </div>
                </form>
            </div>
        </div>
