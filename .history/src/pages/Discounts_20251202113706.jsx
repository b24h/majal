  ...
  return (
    <div className="p-8 relative min-h-screen">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md max-h-[90vh] flex flex-col p-6 relative">
            ...
            <div className="px-6 pb-6 overflow-y-auto">
              ...
              <input type="text" value={form.title} onChange={(e) => setForm({...form, title: e.target})} className="mt-1 w-full border rounded-lg p-2" />
              ...
              />
              <input type="number" placeholder="Pourcentage" value={form.percentage}
      ...
      {showEditModal && (
              <div className="px-6 pb-6 overflow-y-auto">
                <label className="text-sm font-medium text-gray-700">Nom</label>
                <input type="text" value={editingPack?.name || ""} onChange={(e) => setEditingPack((p) => ({ ...p, name: e.target.value }))} className=""/>
              <div>
