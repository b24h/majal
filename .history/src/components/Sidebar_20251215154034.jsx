        ...
        <div className={`fixed left-0 top-0 h-screen bg-cyan-900 text-white flex flex-col transition-all duration-300 ${
            ...
            <nav className="sidebar-scroll flex-1 px-3 py-6 space-y-3 overflow-y-auto">
                ...
                <SidebarGroup>
                    ...
                    <SidebarLink to="/products/discounts" icon={<ShoppingBag size={20}/>} label="Ventes" collapsed={collapsed}/>
                    <SidebarLink to="/products/coupons" icon={<ShoppingBag size={20}/>} label="Ventes" collapsed={collapsed}/>
                    <SidebarLink to="/products/ventes" icon={<ShoppingBag size={20}/>} label="Ventes" collapsed={collapsed}/>
