...
export default function Categories() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      let res;
      if (editingCategory) {
        res = await categoriesService.update(editingCategory.id, catData);
        ...
        res = await categoriesService.create(catData);
