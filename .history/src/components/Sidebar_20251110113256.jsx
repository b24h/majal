...
export default function Sidebar(){
    ...
    return(
        <div className={`${ collapsed ? "w-20" : "w-64"} bg-indigo-700 text-white h-screen flex flex-col transition-all duration-300 fixed`}>
            ...
            <button onClick={handleLogout} className="flex items-center justify-center gap-2 py-3 text-red-300 hover:bg-red-600/20 hover:text-red-100 transition"></button>
        </div>
    )
}