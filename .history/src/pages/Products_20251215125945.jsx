...
export default function Products() {
  ...
  const handleSubmit = async () => {
    try {
      const payload = {
        ...
        attachmentRequests: modalData.attachmentRequests
      };
      if (editMode) {
  ...
  const openEditModal = (product) => {
    ...
    setModalData({
      ...
      attachmentRequests: product.attachmentRequests || [],
    });
    setPreviewImage(`data:image/jpeg;base64,${product.photo}`);
    setShowModal(true);
  };
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesStatus = filter === "Tous";

      const matchesCoop =
        selectedCooperative === "Tous" ||
        product.cooperativeName === selectedCooperative;
  ...
  }, [products, search, filter, selectedCooperative, selectedCategory]);
              ...
              <input
                ...
                onChange={async (e) => {
                  ...
                  if (file) {
                    ...
                    setModalData({ ...modalData, photo: base64 });
