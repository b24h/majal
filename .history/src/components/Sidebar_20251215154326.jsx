        ...
        <div className={`fixed left-0 top-0 h-screen bg-cyan-900 text-white flex flex-col transition-all duration-300 ${
            ...
            <nav className="sidebar-scroll flex-1 px-3 py-6 space-y-3 overflow-y-auto">
                ...
                <SidebarGroup
                    ...
                    collapsed={collapsed}
                    open={productsOpen}
                    toggle={() =>setProductsOpen(!pr)}
                    >
                    <SidebarLink to="/products/list" icon={<ShoppingBag size={20}/>} label="Ventes" collapsed={collapsed}/>
                    <SidebarLink to="/products/discounts" icon={<Percent size={20}/>} label="Ventes" collapsed={collapsed}/>
                    <SidebarLink to="/products/coupons" icon={<Gift size={20}/>} label="Ventes" collapsed={collapsed}/>
                    <SidebarLink to="/products/packs" icon={<Tag size={20}/>} label="Ventes" collapsed={collapsed}/>
