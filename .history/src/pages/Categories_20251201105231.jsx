...
export default function Categories() {
  ...
  return (
    <div className="p-6 font-poppins">
      <div className="flex justify-between items-center mb-6">
        <div>
                ...
                <div className="flex items-center gap-3">
                  <SearchBar onChange={(e) => setSearch}></SearchBar>
                  <AddButton onClick={openAddModal}>Créer un pack</AddButton>
                </div>
      </div>
      <h1 className="text-2xl font-semibold mb-6">Gérer les catégories</h1>
      ...
      <button onClick={() => setShowAddModal(true)} className="fixed bottom-18 right-8 bg-[#2ba4b9] text-white rounded-full p-4 shadow-lg hover:bg-[#238a9c] transition">
        <Plus size={24}/>
      </button>
      {showAddModal && (
          ...
          <div className="bg-white p-6 rounded-xl w-[90%] max-w-md shadow-xl relative">
            ...
            <form onSubmit={handleAdd} className="flex flex-col gap-4">
              ...
              <div className="flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => {setShowAddModal(false); setNewCategory({ name: ""});}}
          ...
          <div className="bg-white p-6 rounded-xl w-[90%] max-w-md shadow-xl">
            ...
            <form onSubmit={handleEditSave} className="flex flex-col gap-4">
              <input
                ...
                className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#2ba4b9]" autoFocus />
              <div className="flex justify-end gap-3">
                <button 
                  type="button"
                  ...
                  <button type="submit" className="bg-[#2ba4b9] text-white px-4 py-2 rounded-lg hover:bg-[#238a9c]">Sauvegarder</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-xl w-[90%] max-w-sm shadow-xl">
            ...
            <p className="text-gray-600 mb-4">
              Attention vous avez cliqué sur "Supprimer". Voulez-vous vraiment supprimer cette catégorie ?
            </p>
            <div className="flex justify-end gap-3">
              <button 
                onClick={() => {setShowDeleteConfirm(false); setPendingDeletedId(null);}}
                className="px-4 py-2 border border-gray-400 rounded-lg hover:bg-gray-100">
                  Annuler
              </button>
              <button
