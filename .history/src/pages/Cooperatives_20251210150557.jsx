...
import cooperativesService
import cooperativesService from './../../.history/src/api/cooperativesService_20251210145956';
...
export default function Cooperatives() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try{
        const [cooperativesRes] = await Promise.all([
          axios.get("/data/cooperatives.json")
        ]);
